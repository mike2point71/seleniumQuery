...
package ht.mikewrig.seleniumquery.browser.driver.builders;

import static ht.mikewrig.seleniumquery.browser.driver.builders.DriverInstantiationUtils
    .customPathWasProvidedAndExecutableExistsThere;
import static ht.mikewrig.seleniumquery.browser.driver.builders.DriverInstantiationUtils.executableExistsInClasspath;
import static ht.mikewrig.seleniumquery.browser.driver.builders.DriverInstantiationUtils.getFullPath;
import static ht.mikewrig.seleniumquery.browser.driver.builders.DriverInstantiationUtils.getFullPathForFileInClasspath;
...
import ht.mikewrig.seleniumquery.browser.driver.DriverBuilder;

/**
 * Builds {@link ChromeDriver} instances for {@link ht.mikewrig.seleniumquery.browser.driver.SeleniumQueryDriver}.
 *
 * @author acdcjunior
 * @since 0.9.0
 */
